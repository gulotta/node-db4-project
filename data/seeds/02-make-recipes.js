...
const ingredients = [
 ...
 { ingredient_name: 'Chicken', ingredient_unit: 'kilo' },
...
const steps = [
    ...
    {step_text: 'Add pesto pasta', step_number: 3  , recipe_id: 1 },
    // Lemon Chicken
    {step_text: 'Heat oven to 500 degrees', step_number: 1 , recipe_id: 2 },
    {step_text: 'Put chicken and lemon in oven', step_number: 2 , recipe_id: 2 },
    {step_text: 'Put in oven', step_number: 3 , recipe_id: 2 },
    // Salmon en Papillote
    {step_text: 'Collect salmon', step_number: 1 , recipe_id: 3 },
